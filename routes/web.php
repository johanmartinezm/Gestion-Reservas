...
Route::get('/', function () {
    $endpoints = [
        ['method' => 'POST', 'path' => '/api/v1/reservations', 'desc' => 'Crear una reserva'],
        ['method' => 'POST', 'path' => '/api/v1/reservations/{id}/cancel', 'desc' => 'Cancelar y calcular reembolso'],
        ['method' => 'GET', 'path' => '/api/v1/reservations/{id}', 'desc' => 'Ver una reserva'],
        ['method' => 'GET', 'path' => '/api/v1/users/{id}/reservations?from=&to=', 'desc' => 'Listar reservas de un usuario por rango'],
        ['method' => 'GET', 'path' => '/api/v1/professionals/{id}/availability?date=&service_id=', 'desc' => 'Horarios libres de un profesional'],
    ];
    ...
    $examples = [
        ...
        [
            'method' => 'GET',
            'path' => '/api/v1/users/{id}/reservations',
